...
import me.progfrog.counponconsumer.TestConfig;
...
class CouponIssueListenerTest extends TestConfig {
    ...
    @Test
    @DisplayName("쿠폰 발급 큐에 처리 대상이 없다면, 발급을 하지 않음")
    public void issue_1() throws JsonProcessingException {
        // given
        // nothing to do
    ...
    @Test
    @DisplayName("쿠폰 발급 큐에 처리 대상이 있다면, 발급 진행")
    public void issue_2() throws JsonProcessingException {
        // given
        long couponId = 1;
        long userId = 1;
    ...
    @Test
    @DisplayName("쿠폰 발급 큐에 처리 대상이 있다면, 발급 진행")
    public void issue_3() throws JsonProcessingException {
        // given
        long couponId = 1;
        long userId1 = 1;
        long userId2 = 2;
